...
function changeColor(color)
{
	if (color == "blue")
	{
			document.body.style.background ="#2D00CF";
	}
		else if (color == "red")
		{
			...
			{
				document.body.style.background = "#25F53D";
			}
				else
					{
...
function loadStatsPage()
{
		...
		{
			if (table.rows[row_counter].cells[2].innerHTML > table.rows[row_counter].cells[3].innerHTML) // buffs
			{
